public class MergeSort {
 ...
 // Why did we choose Merge Sort algorithm ? Why not bubble sort or insertion sort or quick sort.
 // Because closeness of new comer to applicants changes with the value of new comer.Maybe results will become partly sorted.
 // Maybe it will not .We can't predict.Thats why we chose MergeSort algoritm.It is better than other sorting algorithms 
 // in worst case .
     ...
     public void merge(Applicant arr[], int l, int m, int r) { 
		...
		Applicant R[] = new Applicant [n2]; 
		                                       // We changed MergeSort a little bit. Because we have to sort an array                                                        
